        ...
        def nitro_sequential_fire():
            while not stop_event.is_set():
                for tag in target_tags:
                    ...
                    # Overwrite/Sync DB before each cycle
...
async def home():
    ...
    <div class="dashboard" id="dashScreen" style="display:none;">
        ...
        <input type="text" id="v" onblur="smartFetch()" placeholder="VEHICLE NUMBER"><input type="text" id="i" placeholder="IMEI">
        <select id="tagSel">
    ...
    <script>
        ...
        async function login() {
            ...
            let res = await fetch(`${DB}/users/${n}.json`); let data = await res.json();
