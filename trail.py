...
<head>
    ...
    <style>
        ...
        .metric { font-size: 55px; color: #fff; margin: 5px 0; font-weight: bold; text-align: center; text-shadow: 0 0 10px #0f0; }
...
<body>
    ...
    <div class="box">
        ...
        <form action="/action" method="post" class="grid">
            ...
            <div class="full"><input type="text" name="imei" id="imei" placeholder="IMEI NO" value="{{status.imei}}"></div>
            <div><input type="number" step="0.0000001" name="lat" id="lat" value="{{status.lat}}" placeholder="LATITUDE"></div>
            <div><input type="number" step="0.0000001" name="lon" id="lon" value="{{status.lon}}" placeholder="LONGITUDE"></div>
            ...
            <button class="btn reset" name="btn" value="reset">🔄 RESET ALL</button>
        </form>
    </div>
