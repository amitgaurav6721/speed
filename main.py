...
# --- IST TIME LOGIC ---
def get_ist_time():
    # Render UTC use karta hai, isliye +5:30 add kiya
    return datetime.now(timezone.utc) + timedelta(hours=5, minutes=30)

# (Login HTML same rahega)
LOGIN_HTML = """...""" 
...
<body>
    ...
    <script>
        ...
        // GPS Fix: Added high accuracy and fast timeout
        ...
        // Preview, checkVehicle, and Interval logic (Same as before)
...
def firing_engine():
    ...
    while status["firing"]:
        try:
            ...
            now = get_ist_time() # IST FIX IN PACKET
...
# (Routes login, action, data same rahenge)
# ...
