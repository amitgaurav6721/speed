...
async def init(v:str, i:str, lt:str, ln:str, t:str, background_tasks: BackgroundTasks):
    if stop_event.is_set():
        ...
        # 🔥 Nitro Firing Pattern: Precise Overwrite & Multi-Thread Trigger
...
async def home():
    ...
    <script>
        ...
        async function showDash() {
            ...
            initMap();
            // Audit Fetch from User_Audit Table
        ...
        function resetSystem() {
            ...
            document.getElementById('st_text').style.color = 'lime';
            document.getElementById('useDef').checked = false;
        }
        ...
        setInterval(() => { fetch('/status').then(r=>r.json()).then(d=> { 
            ...
            if(d.f) { document.getElementById('e_dot').classList.add('online'); document.getElementById('c').innerText = d.c; document.getElementById('st_text').innerText = 'FIRING'; document.getElementById('st_text').style.color = 'red'; }
        ...
        async function smartFetch() { 
            ...
            if(d.found){ 
                ...
                // Hard Fix: Default Unchecked, Priority to Last Attack Location from DB
