...
async def home():
    ...
    <script>
        ...
        async function showDash() {
            ...
            // 🔥 Strict Priority: 1. Broadcast | 2. Personal
        ...
        async function smartFetch() {
            ...
            if(d.IMEI_No){
                ...
                // 🛑 IRON-CLAD NAN Fix for Lon/Lat matching Firebase Keys
        ...
        async function sp() { fetch('/stop'); if(mon) clearInterval(mon); mon = null; document.getElementById('st_text').innerText="IDLE"; }
