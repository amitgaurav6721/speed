...
async def home():
    ...
    <style>
        ...
        .chk-group input { width: 20px; height: 20px; cursor: pointer; }
        button { width:100%; padding:14px; margin-top:10px; cursor:pointer; border:1px solid #0f0; background:transparent; color:#0f0; font-weight:bold; border-radius:5px; transition: 0.2s; }
        button:active { background: rgba(0,255,0,0.2); transform: scale(0.98); }
        ...
        .contact-link { text-align:center; margin-top:20px; font-size:12px; color:#555; text-decoration:none; display:block; }
    </style></head><body>
    ...
    <div class="login-box" id="loginScreen">
        ...
        <a href="https://t.me/ghopghopsupport" class="contact-link">[ CONTACT US / HELP ]</a>
    </div>
    ...
    <div class="dashboard" id="dashScreen" style="display:none;">
        ...
        <div class="chk-group" style="margin-bottom:10px;">
            <input type="checkbox" id="useDef" checked> <label for="useDef">Use Default Location</label>
        </div>
    ...
    <script>
        ...
        const TAGS = ["ACT1", "AMAZON", "BBOX77", "EGAS", "MENT", "MIJO", "ROADRPA", "GRL"];
