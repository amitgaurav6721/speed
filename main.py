...
async def home():
    ...
    <style>
        ...
        .nav { width:95%; max-width:440px; display:flex; justify-content:space-between; font-size:12px; margin-top:10px; color:#fff; display:none; }
    </style></head><body>
    ...
    <div class="dashboard" id="dashScreen" style="display:none;">
        ...
        <select id="tagSel" onchange="checkManual()"><option value="ALL">SEND ALL TAGS (DEFAULT)</option><option value="MANUAL">+ ADD NEW TAG</option></select>
        <input type="text" id="manTag" placeholder="ENTER NEW TAG" style="display:none;">
