...
async def home():
    ...
    <style>
        ...
        .progress-bar { width: 0%; height: 100%; background: #0f0; box-shadow: 0 0 10px #0f0; transition: width 0.4s; }
    ...
    <div class="nav" id="dashNav"><span>USER: <b id="u_name" style="color:#0f0"></b></span><span onclick="logout()" style="color:red;cursor:pointer;">[ LOGOUT ]</span></div>
    ...
    <div class="dashboard" id="dashScreen" style="display:none;">
        ...
        <select id="tagSel"><option value="MARK">MARK (DEFAULT)</option><option value="MANUAL">+ ADD NEW TAG</option></select>
    ...
    <script>
        ...
        async function showDash() {
            ...
            if(bData && bData.text) { wall.innerHTML = `● <b>UPDATE:</b> ${bData.text}`; wall.style.display = 'block'; }
        }
